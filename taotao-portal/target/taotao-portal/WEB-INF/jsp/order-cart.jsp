...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="杨天远"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15600097721"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="上地xxxxxxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">杨天远</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">156****7721</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">北京 海淀区</div>
						<div class="adr-m" limit="30">上地 xxxxxxxx</div>
